  ...
  md.use(container, 'demo', {
    ...
    render(tokens: any[], idx: number) {
      ...
      if (token.nesting === 1) {
        ...
        const index = generateVueComponent(templateCodeContent)
        const component = `<component :is='component${index}'></component>`
         ...
         * </DemoBlock>
         *  
         * 增加startTitle、endTitle标识符，最后使用正则将其移除，只留下临时组件component
         * */ 
...
const generateVueComponent = (code: string) => {
